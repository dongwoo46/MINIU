...
export function MobileShell({ active, onTabChange, hideChrome, children }: { active: PreviewTab; onTabChange: (tab: PreviewTab) => void; hideChrome?: boolean; children: ReactNode }) {
  const [sheet, setSheet] = useState(false);
  if (hideChrome) {
    return <div className="site-frame"><div className="mobile-shell"><main id="main-content">{children}</main></div></div>;
  }
